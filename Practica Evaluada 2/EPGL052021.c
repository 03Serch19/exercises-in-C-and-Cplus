...
void espejo(Arbol, void (*func)(int*));
int main()
{
	  Arbol ArbolInt = NULL;
	  Insertar(&ArbolInt, 7);
	  ...
	  printf("\n\n");
	  printf("Arbol espejo recorrido en PreOrden: ");
	  espejo(ArbolInt, Mostrar);
	  printf("\n\n");
	  multiNodos(ArbolInt);
...
void espejo(Arbol a, void (*func)(int*))
{
	  if (a == NULL)
	  {
			return;
	  ...
	  {
			if (a->derecho) espejo(a->derecho, func);
			if (a->izquierdo) espejo(a->izquierdo, func);	
			func(&(a->dato));
	  }
}
